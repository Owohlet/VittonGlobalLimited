						...
						<section class="contact-form-blog">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									{{ Form::open(['url'=> 'order_request', 'method' => 'post', 'class'=>'form']) }}
									...
									<div class="row">
										<div class="form-group col-xs-12 col-sm-8">
											<!-- <input type="text" class="form-control" name="inputFullname" id="inputFullname" placeholder="Product Name" required>	 -->
											{{Form::text('inputProductName', null, ['class'=>'form-control', 'placeholder'=>'Product Name']) }}

										</div>
										<div class="form-group col-xs-12 col-sm-4">
											<!-- <input type="text" class="form-control" name="inputFullname" id="inputFullname" placeholder="Quantity" required>	 -->
											{{Form::text('inputProductQty', null, ['class'=>'form-control', 'placeholder'=>'Quantity']) }}
										</div>
									...
									<div class="row">
										<div class="form-group col-xs-12">
											<!-- <textarea class="form-control" rows="3" name="inputMessage" id="inputMessage" placeholder="Full product description" required></textarea> -->
											{{ Form::textarea('inputMessage', null, ['class'=>'form-control', 'placeholder'=>'Describe the product']) }}
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											{{ Form::submit('Send Enquiry', ['class'=>'btn-send']) }}
					...
					<div class="col-sm-4 sidebar">
						<div class="widget">
							...
							<address>
								...
								<a>vittongloballtd@gmail.com</a><br>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col col-sm-4">
								...
								<div class="email">
									<a>{{HTML::link('/contact', 'vittongloballtd@gmail.com') }} </a>								</div>								
								</div>
							</div>
						</div>
					</div>
